...
class UpdateInventory extends Component {
    ...
    componentDidMount = async () => {
        ...
        const resp = await axios.get(`http://localhost:3004/inventory/${id}`);
        const {marka,model,code,name,licence,licencedate} = resp.data;
        this.setState({
            marka,
            model,
            code,
    ...
    updateInventory = async (e) =>{
        ...
        const {id} = this.props.match.params;
        await axios.put(`http://localhost:3004/inventory/${id}`,updatedInventory);
